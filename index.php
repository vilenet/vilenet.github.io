               ...
               <div class="top-nav s-12 l-10 right">
                  ...
                  <ul class="right">
                     ...
                     <li>
                        <a>CS</a>
                        <ul>
                           <li><a>Sorting Algorithms</a>
                             <ul>
                                 <li><a>Bubble Sort</a></li>
                                 <li><a>Selection Sort</a></li>
                                 <li><a>Counting Sort</a></li>
                              </ul>
                           </li>
                           <li><a>Searching Algorithms</a></li>
                           <li>Data Structures</li>
                        </ul>
                     </li>
                     <li>
                        <a>Standart C++ Library</a>
                        <ul>
                           <li><a>STL</a></li>
                           <li><a>Mylty-Threading</a></li>
                        </ul>
                     </li>
                     <li><a>Boost</a></li>
                  </ul>
            ...
            <div class="margin">
               ...
               <section class="s-12 l-6">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet 
                     ...
                     nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem 
                     insitam;
                     est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius 
